...
def map_output_to_pointcloud(mesh, outputs, inverse_map, label_space="scannet200", confidence_threshold=0.9):
...
def save_colorized_mesh(mesh, labels_mapped, output_file):
    ...
    color_map = {0: [255, 255, 255], 1: [255, 0, 0]}  # White for background  # Red for human
